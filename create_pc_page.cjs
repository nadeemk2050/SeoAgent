...
<div class="wp-block-group alignfull has-light-gray-background-color has-background" style="padding-top:40px;padding-bottom:40px">
    ...
    <div class="wp-block-buttons">
        <!-- wp:button -->
        <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://wa.me/971554779331" target="_blank" rel="noopener">Contact Us on WhatsApp for Current Prices</a></div>
        <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
</div>
